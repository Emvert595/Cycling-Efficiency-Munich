...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [673824.386847, 5325537.326583, 706900.493996, 5346731.725338], maxZoom: 18, minZoom: 11, projection: new ol.proj.Projection({
            code: 'EPSG:25832',
...
map.getView().fit([673824.386847, 5325537.326583, 706900.493996, 5346731.725338], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mapping Urban Cycle Efficiency in Munich</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (217 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This map shows the added travel time that individuals of the 2024 MSc Cartography intake face, caused by traffic lights. Their individual routes across Munich are displayed alongside the traffic lights they encounter.';
            }
